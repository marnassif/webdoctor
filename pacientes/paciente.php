...
<form name="consulta" action="buscapaciente.php" OnSubmit="javascript:return validabusca();" method="post">
	<?php $tipo=1;?>
	<div style="font-family: roboto; align:center; margin-top: 2%;  margin-left: 26%;">
		...
		<button type="button" style="text-align: center; border: solid thick #ffffff; border-radius: 1em;"onClick="parent.location.href='listar.php'">Listar Pacientes
		</button>
		<br/>
	</div>	
</form>
