...
<form name="consulta" action="buscapacientee.php" OnSubmit="javascript:return validabusca();" method="post">
<?php $tipo=1;?>
		<div style="font-family: roboto; align:center; margin-top: 2%;  margin-left: 30%;">
		
 				Paciente: Nome/CPF
				<input type="text" id="busca" name="busca"  size=50/>
				<input type="submit" value="buscar" style="text-align: center; border: solid thick #ffffff; border-radius: 1em; " />
				<button type="button" style="text-align: center; border: solid thick #ffffff; border-radius: 1em;"onClick="parent.location.href='listarr.php'">Listar Pacientes
				</button>
				<br/>
		</div>	
...
<form name="paciente" action="pacientesatualizaa.php" OnSubmit="javascript:return validar();" method="post">
		...
		<div style="margin-top: 53px; margin-left: 400px;" >
			<div style="display:inline-block; vertical-align:top;">
				<table style="align:center; color:#FFFFFF;"> <!-- " -----style="align:center; margin-top: 5%; color:#FFFFFF;" -->
					...
					<tr>
						<td colspan="2" >  <!-- Nome -->
						<input type="text" name="nome" id="nome" size=44/>
					    </td>
					</tr>
					<tr>
					...
					<tr >
						<td> <!-- Data Nascimento -->
							<input type="text" name="nascimento" id="data" maxlength=10 onkeypress="return mascara_data(event,this);" onblur="return ValidarData(this);"  /> 
						</td>
						<td><!-- Sexo -->
					...
					<tr> <!-- convenio sexo -->
						<td ><input type="text" name="cpf" onChange="validarCPF(cpf)" onkeypress="return mascara_cpf(event,this);" maxlength=14/></td>
			...
			<div style="display:inline-block; vertical-align:top;">
				...
				<table style="color:#FFFFFF; align:center;">
					...
					<tr> <!--  -->
						...
						<td><input type="text" name="cep"  maxlength=9 onkeypress="return mascara_cep(event,this);"/></td>
					</tr>
					<!-- CONTATO -->
					...
					<tr> 
						<td><input type="text" name="telefone" value="(xx)xxxx-xxxx" onclick="value=''" onkeypress="return mascara_tel(event,this);" onChange="validarTelefone(this);" maxlength=13/></td>
						<td><input type="text" name="celular" value="(xx)xxxx-xxxx" onclick="value=''" onkeypress="return mascara_tel(event,this);" onChange="validarTelefone(this);"  maxlength=13/></td>
					</tr>			
					...
					<tr> 
						<td colspan="2"><input type="text" name="email" id="email" onChange="validarEmail(email)" size=46/></td>
					</tr>			
				</table>
			</div>
		</div>
...
<?php if($tipo!=1){
	?>
	<div style="float: left; text-align: center; width: 10%; margin-top: -25%;  margin-left: 2.8%;">
		<div>
