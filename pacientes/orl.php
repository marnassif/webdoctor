...
<form name="paciente" action="pacientesatualiza.php" OnSubmit="javascript:return validar();" method="post">
		...
		<table   style="align:center; margin-top: 4%; color:#FFFFFF;" > <!-- class="paciente" style="margin: 40px -96px 0px 500px; color:#FFFFFF;" -----border-right-width: 500px; -->
			...
			<tr><td>Data da Consulta
		 		<input type="text" id="data_consulta" name="data_consulta" onkeypress="return mascara_data(event,this);" onblur="return ValidarData(this);" maxlength=10 size=11/>
		 	</td></tr>
		<tr><th COLSPAN=2 style="text-align:center; font-family:Roboto-Thin; font-size:16px;">Exames Otorrinolaringol&oacute;gicos</th></tr>
				...
				<tr >
					<td COLSPAN=2 ><textarea name="orelha" rows="3" cols="54"></textarea></td>
				</tr>			
				<tr>
					<td>Nariz</td>
				</tr>
				<tr >
					<td COLSPAN=2 ><textarea name="nariz" rows="3" cols="54"></textarea></td>
				</tr>			
				<tr>
					<td>Boca</td>
				</tr>
				<tr >
					<td COLSPAN=2 ><textarea name="boca" rows="3" cols="54"></textarea></td>
				</tr>		
				<tr>
					<td>Faringe</td>
				</tr>
				<tr >
					<td COLSPAN=2 ><textarea name="faringe" rows="3" cols="54"></textarea></td>
				</tr>				<tr>
					<td>Laringe</td>
				</tr>
				<tr >
					<td COLSPAN=2 ><textarea name="laringe" rows="3" cols="54"></textarea></td>
				</tr>
				<tr>
				<td COLSPAN=2 >Face</td>
				</tr>	
				<tr >
					<td COLSPAN=2 ><textarea name="face" rows="3" cols="54"></textarea></td>
				</tr>			
				<tr>
				<td COLSPAN=2 >Cervical</td>
				</tr>	
				<tr >
					<td COLSPAN=2 ><textarea name="cervical" rows="3" cols="54"></textarea></td>
				</tr>
		</table>
		<br/><br/>
